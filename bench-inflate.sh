...
poop "./native-zlib-benchmark-sse42 inflate zlib-rs" "./native-zlib-benchmark-avx2 inflate zlib-rs" "wasmtime run --allow-precompiled baseline-d693fe.cwasm inflate zlib-rs" "wasmtime run --allow-precompiled wasm-zlib-benchmark.cwasm inflate miniz_oxide" "wasmtime run --allow-precompiled wasm-zlib-benchmark.cwasm inflate zlib-ng" "wasmtime run --allow-precompiled wasm-zlib-benchmark.cwasm inflate zlib-rs"
